<?php
 ...
 $sql="SELECT patient_id,patient_name,age,blood_group,diagnosis,telephone_no,address,level FROM patient WHERE hospital_id=$hospital_id ORDER BY patient_id ";
 //echo $sql;
