...
<nav>
        ...
        <li><a onclick='updateNotificationStatus("match_requests","notify1")'  class="active" href="../../src/php/admin_hospital_match_request.php" > Hospital Matching Request </a> </li>
