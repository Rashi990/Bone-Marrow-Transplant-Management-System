...
if(isset($_POST['submit'])){
  ...
  if (empty($donor_id)||empty($date)||empty($drug_name)||empty($dosage)||empty($route)||empty($frequency))
{
  header("Location: consultant_donor_prescription_form.php?error=All feilds are required!");
  exit();
}

    $sql="INSERT INTO donor_clinical_reports(donor_id,date,drug_name,dosage,route,frequency) VALUES($donor_id,'$date','$drug_name','$dosage','$route','$frequency')";
    $result=mysqli_query($connection,$sql);
    if($result){
        //echo "Data inserted successfully";
        header('location:consultant_donor_prescriptions.php');
    }
    else{
  ...
  <div class="board">
    ...
    <div class="form">
      <form class="" action="" method="post">
        <div class="details">
          <div class="d">
            <label class="lbl">Donor ID</label>
